...
## Build yourself
You need to clone the whole respository, checkout and build the modified branch of **CoreELEC** and **EmuELEC** respectively, then get back to the **HybridELEC** and combine the images:
````
git clone https://github.com/7Ji/HybridELEC.git
git checkout coreelec-9.2
PROJECT=Amlogic DEVICE=mibox3 PROFILE=hybrid make
git checkout emuelec-9.2
PROJECT=Amlogic DEVICE=mibox3 PROFILE=hybrid make
